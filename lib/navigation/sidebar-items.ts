...
export const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Dashboard", href: "/investment" },
      { label: "Acciones", href: "/investment/markets" },
      { label: "FOREX", href: "/investment/forex" },
      { label: "Crypto", href: "/investment/crypto" },
      { label: "Opportunities", href: "/investment/opportunities" },
      { label: "Portfolio", href: "/investment/portfolio" },
      { label: "Orders", href: "/investment/orders" },
      { label: "Strategies", href: "/investment/strategies" },
      { label: "Risk", href: "/investment/risk" },
      { label: "News", href: "/investment/news" },
      { label: "Calendar", href: "/investment/calendar" },
      { label: "AI Committee", href: "/investment/ai-committee" },
      { label: "Reports", href: "/investment/reports" },
      { label: "Settings", href: "/investment/settings" },
    ],
  },
  {
    id: "settings",

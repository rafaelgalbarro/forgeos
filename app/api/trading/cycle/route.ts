...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    config: {
      ...
      stocksCycleRunning: TradingEngine.isStocksCycleRunning(),
      cryptoCycleRunning: TradingEngine.isCryptoCycleRunning(),
      forexCycleRunning: TradingEngine.isForexCycleRunning(),
      lastStocksCycle: global.__lastStocksCycle ?? null,
      lastCryptoCycle: global.__lastCryptoCycle ?? null,
      lastForexCycle: global.__lastForexCycle ?? null,

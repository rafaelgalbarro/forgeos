...
const KNOWN_HREFS = new Set([
  ...
  "/api/investment/screener",
  "/api/investment/audit",
  "/api/investment/probe-gather",
  "/api/investment/market-scanner",
  "/api/investment/strategy-center",
  "/api/investment/strategy-lab",
  "/api/investment/alpha-engine",
  "/api/investment/continuous-analysis",
  "/production",
  "/settings",
  "/labs",
  "/ceo",
...
export function isValidSidebarHref(href: string): boolean {
  ...
  if (normalized.startsWith("/investment")) return true;
  return false;
}

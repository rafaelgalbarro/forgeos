"use strict";exports.id=4592,exports.ids=[4592,9830],exports.modules={12287:(a,b,c)=>{function d(a){return a.envVars.map(a=>({key:a.key,description:a.description,example:a.example,required:a.required,secret:a.secret}))}function e(a){return a.map(a=>{let b=`# ${a.description}${a.required?" (required)":""}`;return`${b}

...
const SHORT_ALIASES: Record<string, string> = {
  ...
  "/reconnect": "/api/ibkr/reconnect",
  "/auto-reconnect": "/api/ibkr/auto-reconnect",
  "/history": "/api/ibkr/history",
  "/historical": "/api/ibkr/historical",
  "/quote": "/api/ibkr/quote",
  "/market-data": "/api/ibkr/market-data",
  "/price": "/api/ibkr/quote",
  "/scanner": "/api/ibkr/scanner",
  "/orders/cancel-all": "/api/ibkr/orders/cancel-all",
  "/orders/cancel-stale-presubmitted": "/api/ibkr/orders/cancel-stale-presubmitted",

/** ForgeOS AI embeddings capability — module entry (RC4.7). */

import { EMBEDDINGS_CONFIG } from "../shared/capabilities";
import { createAICapabilityModule } from "../shared/capability-factory";

export const module = createAICapabilityModule(EMBEDDINGS_CONFIG);
...
export { EMBEDDINGS_CONFIG } from "../shared/capabilities";
